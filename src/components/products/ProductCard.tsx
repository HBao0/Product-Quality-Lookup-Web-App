      ...
      <div className="p-4">
        ...
        <div className="mt-3 flex justify-between items-center">
          <span className={`text-xs px-2 py-1 rounded-full ${getSentimentColor(sentiment)}`}>
            {sentimentLabel[sentiment] || 'Không xác định'}
          </span>
          <div className="flex space-x-1">
            <a href="https://shopee.vn" target="_blank" rel="noopener noreferrer" className="p-1 bg-orange-500 text-white rounded" title="Mua trên Shopee">
              <ShoppingCartIcon className="h-3 w-3" />
            </a>
            <a href="https://lazada.vn" target="_blank" rel="noopener noreferrer" className="p-1 bg-blue-500 text-white rounded" title="Mua trên Lazada">
              <ShoppingCartIcon className="h-3 w-3" />
            </a>
            <a href="https://tiki.vn" target="_blank" rel="noopener noreferrer" className="p-1 bg-teal-500 text-white rounded" title="Mua trên Tiki">
              <ShoppingCartIcon className="h-3 w-3" />
            </a>
          </div>
        </div>
