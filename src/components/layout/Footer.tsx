  ...
  return <footer className="bg-white border-t border-gray-200">
      <div className="container mx-auto px-4 py-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-600 text-sm">
              Nền tảng tra cứu chất lượng sản phẩm hàng đầu Việt Nam, giúp người
              tiêu dùng đưa ra quyết định mua sắm thông minh.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-3">
        ...
        <div className="border-t border-gray-200 mt-6 pt-6 text-center text-sm text-gray-600">
          <p>
            © {new Date().getFullYear()} VietChoice. Tất cả các quyền được bảo
            lưu.
          </p>
        </div>
      </div>
