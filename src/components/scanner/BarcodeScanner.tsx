...
const BarcodeScanner = () => {
  ...
  return <div className="flex flex-col items-center">
      {!isScanning && !scanResult && <div className="text-center mb-6">
      ...
      {isScanning && <div className="w-full max-w-md">
      ...
      {scanResult && <div className="w-full max-w-md mt-4">
      ...
      {product && <div className="w-full max-w-md mt-6 bg-white rounded-lg shadow-md overflow-hidden">
          <div className="p-4">
            ...
            <div className="mt-4 flex justify-center space-x-3">
              <a href="https://shopee.vn" target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 bg-orange-500 text-white text-sm rounded-md">
                Mua trên Shopee
              </a>
              <a href="https://lazada.vn" target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 bg-blue-500 text-white text-sm rounded-md">
                Mua trên Lazada
              </a>
              <a href="https://tiki.vn" target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 bg-teal-500 text-white text-sm rounded-md">
                Mua trên Tiki
              </a>
            </div>
          </div>
